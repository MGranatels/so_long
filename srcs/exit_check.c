...
/*   Updated: 2022/06/14 20:51:09 by anne-sophie      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_close(int keycode, t_data *vars)
{
    ...
    {
	    vars->e = 1;
        mlx_put_image_to_window(vars->mlx, vars->win, vars->img.exit_o, 64 * vars->e_j, 64 * vars->e_i);
    }
	return (0);
}
...
{
	vars->nub.n0 = mlx_xpm_file_to_image(vars->mlx, "images/0.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n1 = mlx_xpm_file_to_image(vars->mlx, "images/1.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n2 = mlx_xpm_file_to_image(vars->mlx, "images/2.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n3 = mlx_xpm_file_to_image(vars->mlx, "images/3.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n4 = mlx_xpm_file_to_image(vars->mlx, "images/4.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n5 = mlx_xpm_file_to_image(vars->mlx, "images/5.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n6 = mlx_xpm_file_to_image(vars->mlx, "images/6.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n7 = mlx_xpm_file_to_image(vars->mlx, "images/7.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n8 = mlx_xpm_file_to_image(vars->mlx, "images/8.xpm", &vars->img.width, &vars->img.height);
	vars->nub.n9 = mlx_xpm_file_to_image(vars->mlx, "images/9.xpm", &vars->img.width, &vars->img.height);
}
